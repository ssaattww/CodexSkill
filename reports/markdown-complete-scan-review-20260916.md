...
依存版: Python 3.13.7、Node.js 22.13.1、SudachiPy 0.6.11、SudachiDict core 20260428、PyYAML 6.0.3、cspell 9.8.0。
...
実行環境の表記訂正: OS標準のPython版ではなく、証拠JSONに記録された検証プロセスのPython 3.13.7を記載した。指摘と再現結果に変更はない。
