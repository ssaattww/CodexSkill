...
- For Markdown whitelist creation, rebuild, review, and notation-normalization decisions, follow [references/markdown-whitelist-policy.md](references/markdown-whitelist-policy.md). This policy explains how the user should review vocabulary candidates and how agents must separate extraction, whitelist edits, and `prh` corrections.
