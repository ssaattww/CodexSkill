...
| DW-09 | The project explicitly defines 「散列」 as its canonical term for readers familiar with it, and uses it consistently in concise, unambiguous sentences. | `pass` | The authorized definition, stated audience, and readable sentence support the term. A definition alone does not prove readability; DW-08 is not a blacklist entry. |
